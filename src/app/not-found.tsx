  ...
  return (
    <PageShell>
      <section className="brand-gradient-animated relative flex min-h-[100svh] flex-col justify-center overflow-hidden px-[clamp(20px,5.5vw,80px)] py-40">
        <span
          aria-hidden="true"
          className="animate-float pointer-events-none absolute -right-[4vw] top-1/2 -translate-y-1/2 font-display text-[clamp(200px,40vw,560px)] font-semibold tracking-[-0.015em] leading-none text-white/[0.06]"
        >
          404
        </span>
        <Reveal><SectionLabel dark>ERROR 404</SectionLabel></Reveal>
        <h1 className="mt-8 flex flex-col gap-2">
          <SplitReveal text="LOST IN" className="block font-display text-[clamp(40px,11vw,128px)] font-semibold tracking-[-0.015em] leading-[0.9] text-white" />
          <SplitReveal text="THE PIXELS." delay={140} className="block font-display text-[clamp(40px,11vw,128px)] font-semibold tracking-[-0.015em] leading-[0.9] text-white" />
        </h1>
        <Reveal delay={240}>
