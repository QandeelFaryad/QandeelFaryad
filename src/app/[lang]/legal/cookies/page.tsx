...
export async function generateMetadata(): Promise<Metadata> {
  const t = (await getMessages()).meta.cookies;
  return pageMetadata("/legal/cookies", t.title, fmt(t.description, { entity: SITE.legal.entity, name: SITE.name }));
}

export default async function Page() {
  const t = (await getMessages()).legal.cookies;
