              ...
              <Reveal key={m.title} delay={(i % 4) * 80} scale>
                <Tilt max={5}>
                  <div className="flex h-full flex-col gap-3 rounded-3xl border border-line bg-white p-8">
                    <h2 className="font-display text-[20px] font-bold tracking-[-0.015em] uppercase leading-[1.1] text-ink">
                      {m.title}
                    </h2>
        ...
        <section className="bg-white">
          <div className="container-x grid gap-12 [padding-block:120px] lg:grid-cols-2 lg:items-center lg:gap-20">
            ...
            <div className="flex flex-col gap-6">
              ...
              <Reveal delay={80}>
                <h2 className="font-display text-[clamp(26px,3.4vw,40px)] font-bold tracking-[-0.015em] uppercase leading-[1.05] text-ink">
                  {study.name}
                </h2>
              </Reveal>
              <Reveal delay={140}>
